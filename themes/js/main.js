...
var htmltext = [
    ...
    '<span style="color:#000;font-size:31px;">显示小字</span><br /><br /><span style="font-size:14px;">小字<br/></span>',
    '<span style="color:#000;font-size:31px;">第三行</span><br /><br /><span style="font-size:14px;">啥<br/>Empty void<br/>a Shimmer of Hope</span>'
]
...
function init() {
    ...
    canvas.ondblclick = onDocumentDoubleClick;
...
var _createInstructions = function() {
    ...
    if (inner_tag < 3) {
        text.innerHTML = htmltext[inner_tag];
    }
...
var createInstructions = _.debounce(_createInstructions, 200, {leading: true, maxWait: 1000, trailing: false});
